...
;// CONCATENATED MODULE: external "jets_seatmap_react_lib"
var external_jets_seatmap_react_lib_namespaceObject = require("jets_seatmap_react_lib");
...
/* harmony default export */ var jets_seatmapvue_type_script_lang_js_ = ({
  ...
  mounted() {
    ...
    external_react_dom_default().render(external_react_default().createElement(external_jets_seatmap_react_lib_namespaceObject.JetsSeatMap, reactProps), this.$refs.wrapper);
  },
  render: function () {
